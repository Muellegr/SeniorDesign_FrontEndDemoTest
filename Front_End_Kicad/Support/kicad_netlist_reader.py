        ...
        for c in components:
            if c.grouped == False:
                ...
                for ci in components:
                    if ci.grouped == False and ci == c and ci.getField("part_details") == c.getField("part_details") and ci.getField("part_url") == c.getField("part_url") and ci.getField("Footprint") == c.getField("Footprint")and ci.getField("part_name") == c.getField("part_name"):
                        newgroup.append(ci)
                        ci.grouped = True
